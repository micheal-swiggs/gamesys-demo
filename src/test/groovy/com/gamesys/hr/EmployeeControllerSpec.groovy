...
class EmployeeControllerSpec extends Specification {
    ...
    def populateValidParams(params) {
        assert params != null
        params["fullName"] = "Full Namer"
        params["startDate"] = new Date()
        params["holidayAllowance"] = 22
    }

    void setupSpec() {
        mockDomain(Employee, [
            ["White Blue", new Date(), 22]
        ])
    }
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        when:"The save action is executed with an invalid instance"
            ...
            def employee = new Employee(fullName: "Blue White", startDate: new Date(), holidayAllowance: 5)
            employee.validate()
